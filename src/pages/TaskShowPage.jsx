...
const TaskShowPage = () => {
  ...
  return (
    <Layout>
      <div className="w-[715px] h-[239px] top-[140px] left-[121px] gap-[26px] mt-[70px]">
      ...
      <div className="w-[493px] h-[277px] top-[442px] left-[121px] flex flex-col justify-between mt-7">
        <div className="text-[#2A2A2A] text-[24px] font-bold leading-[100%] tracking-[0%]">
          დავალების დეტალები
        </div>
        ...
        <div className="flex justify-between">
          ...
          <select
            ...
            className="w-[259px] h-[45px] gap-[10px] rounded-[5px] border-[1px] border-[#CED4DA] p-[10px] text-sm"
            onChange={(e) => {
